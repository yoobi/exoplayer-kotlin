...
import io.github.yoobi.drmdownloadvideo.OnlineAdapter.Companion.BUNDLE_LICENSE_URL
import io.github.yoobi.drmdownloadvideo.OnlineAdapter.Companion.BUNDLE_MIME_TYPES
import io.github.yoobi.drmdownloadvideo.OnlineAdapter.Companion.BUNDLE_TITLE
import io.github.yoobi.drmdownloadvideo.OnlineAdapter.Companion.BUNDLE_URL
import io.github.yoobi.drmdownloadvideo.R
import io.github.yoobi.drmdownloadvideo.common.DownloadTracker
import io.github.yoobi.drmdownloadvideo.common.DownloadUtil
import io.github.yoobi.drmdownloadvideo.common.MediaItemTag
import io.github.yoobi.drmdownloadvideo.common.PieProgressDrawable
...
class PlayerActivity : AppCompatActivity(), DownloadTracker.Listener {
    ...
    private val mediaItem: MediaItem by lazy {
        MediaItem.Builder()
            ...
            .setDrmConfiguration(DrmConfiguration.Builder(C.WIDEVINE_UUID)
                .setLicenseUri(intent.getStringExtra(BUNDLE_LICENSE_URL))
                .build()
            )
    ...
    private fun createMediaSourceFactory(): MediaSource.Factory {
        ...
        drmSessionManagerProvider.setDrmHttpDataSourceFactory(
            DownloadUtil.getHttpDataSourceFactory(this)
        )
        return DefaultMediaSourceFactory(DownloadUtil.getReadOnlyDataSourceFactory(this))
